...
var clickOnImage = function clickOnImage(e) {
  if (e.target.dataset.image && e.target.classList.contains('slider__item')) {
    var currentImage = slider.querySelector('.slider__current');
    currentImage.classList.remove('slider__current');
...
},{}],"js/card-switcher.js":[function(require,module,exports) {
var cards = document.getElementById('cards');

var cardSwitcher = function cardSwitcher(e) {
  if (!e.target.classList.contains('dining-card_top') && e.target.classList.contains('dining-card')) {
    var currentTopCard = cards.querySelector('.dining-card_top');
...
require("./card-switcher");
},{"./hamburger":"js/hamburger.js","./slider":"js/slider.js","./card-switcher":"js/card-switcher.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
